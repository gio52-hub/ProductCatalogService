...
func MapProductResponseToProto(resp *queries.ProductResponse) *pb.Product {
	if resp == nil {
		return nil
	}
...
func MapListProductsResponseToProto(resp *queries.ListProductsResponse) *pb.ListProductsReply {
	if resp == nil {
